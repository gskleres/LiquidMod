...
function AssignStartingPlots:__InitStartingData()
	...
	self.playerStarts[2] = {X = 20, Y = 15};
	
	--team 2 (east)
	self.playerStarts[3] = {X = 28, Y = 29};
	...
	for i = 0, self.iNumMajorCivs - 1 do
		...
		print("Player " .. i .. " Start X " .. position.X .. " Start Y " .. position.Y);
...
function AssignStartingPlots:__MajorCivBuffer(plot)
	...
	local iMaxStart = 7;--GlobalParameters.START_DISTANCE_MAJOR_CIVILIZATION or 9;
